  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#fffdfc_0%,#f7f7fa_100%)] px-4 py-4 text-[color:var(--brand-dark)] sm:px-6 sm:py-5 lg:px-8 lg:py-6">
      <div className="mx-auto w-full max-w-7xl space-y-6">
        <DashboardTopbar userLabel={userLabel} activeLabel="" />

        <section className="grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
          <article className="rounded-[1.9rem] border border-[#eadcd2] bg-white p-6 shadow-[0_22px_55px_rgba(22,36,61,0.06)]">
